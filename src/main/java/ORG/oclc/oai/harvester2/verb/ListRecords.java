...
public class ListRecords extends HarvesterVerb {
     ...
     * @exception XPathExpressionException an XPath processing error occured
     */
    ...
    throws TransformerException, NoSuchFieldException, XPathExpressionException {
        return getSingleString("/OAI-PMH/ListRecords/resumptionToken");
    }
